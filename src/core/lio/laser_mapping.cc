...
bool LaserMapping::Run() {
    ...
    if(tf_callback_)
    {
        ...
        msg.transform.translation.z = cur_pose.translation().z();

        msg.transform.rotation.x = cur_pose.so3().unit_quaternion().x();
        msg.transform.rotation.y = cur_pose.so3().unit_quaternion().y();
        msg.transform.rotation.z = cur_pose.so3().unit_quaternion().z();
        msg.transform.rotation.w = cur_pose.so3().unit_quaternion().w();
    ...
    if(odom_callback_)
    {
        ...
        msg.pose.pose.position.z = cur_pose.translation().z();

        msg.pose.pose.orientation.x = cur_pose.so3().unit_quaternion().x();
        msg.pose.pose.orientation.y = cur_pose.so3().unit_quaternion().y();
        msg.pose.pose.orientation.z = cur_pose.so3().unit_quaternion().z();
        msg.pose.pose.orientation.w = cur_pose.so3().unit_quaternion().w();
...
void LaserMapping::SetTFCallback(TFCallback&& callback) { tf_callback_ = callback; }
void LaserMapping::SetOdomCallback(OdomCallback&& callback) { odom_callback_ = callback; }
